...
function Privacy(): JSX.Element {
  return (
    <main className=" text-headline font-paragraph">
      <div className="lg:px-10 px-2 space-y-2">
        {' '}
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to CINEFLEX, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to CINEFLEX.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to CINEFLEX, accessible from{' '}
              <a
                href="https://cineflex.netlify.app"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <ul>
          <li>
            ...
            <a
              href="https://cineflex.netlify.app/contact"
              rel="noreferrer"
              target="_blank"
            >
              https://cineflex.netlify.app/contact
            </a>
          </li>
        </ul>
      </div>
